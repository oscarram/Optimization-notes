\begin{theorem}
	...
	\begin{proof}
		...
		i.e. $A^*p^* \in \partial (J\circ A)(u) \implies A^* \partial J(Au)\subseteq \partial (J\circ A)(u)$. The other implication,
		\[
		\partial (J\circ A)(u)\subseteq A^* \partial J(Au),
		\]
		is based in the Hann-Bannach Theorem and separation of the spaces.
		\end{proof}
\end{theorem}
